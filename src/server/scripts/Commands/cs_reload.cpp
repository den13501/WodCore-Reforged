...
public:
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading server motd...");
        sWorld->LoadDBMotd();
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading LFR Access Requirement definitions...");
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading LFG Entrances definitions...");
    ...
    static bool HandleReloadQuestTemplateCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading Quest Objectives...");
