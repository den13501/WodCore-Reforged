...
void World::LoadConfigSettings(bool reload)
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SERVER_LOADING, "CharactersPerRealm (%i) must be in range 1..11. Set to 11.", m_int_configs[CONFIG_CHARACTERS_PER_REALM]);
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SERVER_LOADING, "Currency.ConquestPointsWeekCap (%i) must be > 0, set to default 1500.", m_int_configs[CONFIG_CURRENCY_CONQUEST_POINTS_WEEK_CAP]);
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SERVER_LOADING, "Currency.ConquestPointsWeekCap (%i) must be > 0, set to default 200.", m_int_configs[CONFIG_CURRENCY_ASHRAN_CONQUEST_POINTS_WEEK_CAP]);
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SERVER_LOADING, "Currency.ConquestPointsRatedBGReward (%i) must be > 0, set to default 400.", m_int_configs[CONFIG_CURRENCY_CONQUEST_POINTS_RATED_BG_REWARD]);
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Initialize Spell Difficulty ...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading SpellPowerInfo store....");
    ...
    {
        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Research Site Zones...");
        sObjectMgr->LoadResearchSiteZones();

        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Research Site Loot...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Garrison Plot Building Content...");
    sObjectMgr->LoadGarrisonPlotBuildingContent();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Npc Recipes Conditions...");
    ...
    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading Item Specs override...");                    ///< must be after LoadItemPrototypes
    sObjectMgr->LoadItemSpecsOverride();

    if (sWorld->getBoolConfig(CONFIG_ENABLE_ITEM_SPEC_LOAD))
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading Item Specs...");                   // must be after LoadItemPrototypes
        sObjectMgr->LoadItemSpecs();
    }

    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading Item Bonus Group...");                       ///< must be after LoadItemPrototypes
    sObjectMgr->LoadItemBonusGroup();

    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading Item Bonus Group Linked...");                ///< must be after LoadItemPrototypes
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Equipment templates...");             // Must be after LoadCreatureTemplate
    sObjectMgr->LoadEquipmentTemplates();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Creature templates difficulties...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Currency Loot Templates...");
    sObjectMgr->LoadCurrencyOnKill();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Currency Loot Templates Personnal...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Creature Group Size Stats...");
    ...
    if (sWorld->getBoolConfig(CONFIG_ENABLE_QUEST))
    {
        ...
        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Quest Objectives...");
        sObjectMgr->LoadQuestObjectives();

        TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Quest Objective Locales...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading LFG entrance positions...");
    sLFGMgr->LoadEntrancePositions();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading SpellArea Data...");                // must be after quest load
    sSpellMgr->LoadSpellAreas();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Spell Classes Info...");
    sSpellMgr->LoadSpellClassInfo();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Talent Place Holder spell...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading LFR Access Requirements...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading spells upgrade item stage...");
    sSpellMgr->LoadSpellUpgradeItemStage();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading spells invalid...");
    sObjectMgr->LoadSpellInvalid();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading spells stolen...");
    sObjectMgr->LoadSpellStolen();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading disabled rankings...");
    sObjectMgr->LoadDisabledEncounters();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading conversation templates...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading pet stats...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Cinematic path ...");
    sCinematicSequenceMgr->Load();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading AreaTrigger templates...");
    sObjectMgr->LoadAreaTriggerTemplates();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading AreaTrigger move splines...");
    sObjectMgr->LoadAreaTriggerMoveSplines();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading AreaTrigger move templates...");
    sObjectMgr->LoadAreaTriggerMoveTemplates();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading FollowerQuests...");
    sObjectMgr->LoadFollowerQuests();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Bonus quest...");
    sObjectMgr->LoadBonusQuests();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading QuestForItem...");
    sObjectMgr->LoadQuestForItem();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Spell Auras Not Save...");
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Calculate next daily loot reset time...");
    InitDailyLootResetTime();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Calculate next weekly guild challenges reset time...");
    InitGuildChallengesResetTime();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Calculate next weekly boss looted reset time...");
...
#ifdef CROSS
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading InterRealm config...");
...
#ifndef CROSS
    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading guild challenge rewards...");
    sObjectMgr->LoadGuildChallengeRewardInfo();

    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading black market templates...");
    sBlackMarketMgr->LoadTemplates();

    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading black market auctions...");
    ...
    TC_LOG_INFO(LOG_FILTER_GENERAL, "Loading area skip update...");
    sObjectMgr->LoadSkipUpdateZone();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading BattlePet template...");
    sObjectMgr->LoadBattlePetTemplate();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading BattlePet npc team member...");
    sObjectMgr->LoadBattlePetNpcTeamMember();
    ///sObjectMgr->ComputeBattlePetSpawns();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading Wild BattlePet pools...");
    sWildBattlePetMgr->Load();

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading character template data...");
    sObjectMgr->LoadCharacterTemplateData();

#ifndef CROSS
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading realm completed challenges...");
    sObjectMgr->LoadRealmCompletedChallenges();
#endif

    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loading challenge mode rewards...");
    sObjectMgr->LoadChallengeRewards();

#ifndef CROSS
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Init Garrison shipment manager...");
...
void World::LoadCharacterInfoStore()
{
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, "Loaded name data for %u characters in %u ms.", count, GetMSTimeDiffToNow(l_OldMSTime));
}
