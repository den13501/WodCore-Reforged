...
void GuildMgr::LoadGuilds()
{
    ...
    TC_LOG_INFO(LOG_FILTER_GENERAL, "Validating guild Challenges...");
    {
        ...
        if (l_Result)
        {
            ...
            TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u guild challenges in %u ms", l_Count, GetMSTimeDiffToNow(l_OldMSTime));
        }
    }
...
void GuildMgr::LoadGuildRewards()
{
    ...
    do
    {
        ...
        {
            TC_LOG_ERROR(LOG_FILTER_SERVER_LOADING, "Guild rewards contains not existing achievement entry %u", reward.AchievementId);
            continue;
        }
