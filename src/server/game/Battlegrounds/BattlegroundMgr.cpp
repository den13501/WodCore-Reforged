    ...
    namespace Battlegrounds
    {
        ...
        void BattlegroundMgr::CreateInitialBattlegrounds()
        {
            ...
            do
            {
                ...
                {
                    TC_LOG_ERROR(LOG_FILTER_SQL, "Table `battleground_template` for id %u has bad values for MinPlayersPerTeam (%u)",
                ...
                {
                    TC_LOG_ERROR(LOG_FILTER_SQL, "Table `battleground_template` for id %u have non-existed WorldSafeLocs.dbc id %u in field `AllianceStartLoc`. BG not created.", l_Data.bgTypeId, l_StartId);
                    continue;
                }
                ...
                {
                    TC_LOG_ERROR(LOG_FILTER_SQL, "Table `battleground_template` for id %u have non-existed WorldSafeLocs.dbc id %u in field `HordeStartLoc`. BG not created.", l_Data.bgTypeId, l_StartId);
                    continue;
                }
            ...
            TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u battlegrounds in %u ms", l_Count, GetMSTimeDiffToNow(l_OldMSTime));
        }
        ...
        void BattlegroundMgr::LoadBattleMastersEntry()
        {
            ...
            do
            {
                ...
                {
                    TC_LOG_ERROR(LOG_FILTER_SQL, "Table `battlemaster_entry` contain entry %u for not existed battleground type %u, ignored.", l_Entry, l_BgTypeId);
                    continue;
                }
            ...
            TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u battlemaster entries in %u ms", l_Count, GetMSTimeDiffToNow(l_OldMSTime));
        }
