...
bool BattlegroundDG::SetupBattleground()
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundDG: Failed to spawn Alliance-Northern spirit guide! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundDG: Failed to spawn Alliance-Southern spirit guide! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundDG: Failed to spawn Horde-Northern spirit guide! Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundDG: Failed to spawn Horde-Southern spirit guide! Battleground not created!");
        return false;
    }
