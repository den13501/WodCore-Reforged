...
const uint32 BG_AV_CreatureInfo[AV_NPC_INFO_MAX][4] = {
    ...
    { 13358, 1216, 49, 49 }, //Stormpike Bowman /// @todo: Confirm if this is correct. Author assumpted 60,61 & 69,70, but wouldn't work here
    ...
    {13396, 469, 45, 46}, // irondeep alliance /// @todo: Correct and give correct ids
    {13080, 469, 45, 46},
    {13098, 469, 46, 47},
    {13078, 469, 48, 48},
