...
bool BattlegroundSM::SetupBattleground()
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundSM: Failed to spawn some object Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundSM: Failed to spawn some creatures Battleground not created!");
        return false;
    }
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "BatteGroundSM: Failed to spawn spirit guide! Battleground not created!");
        return false;
    }
