    ...
    do
    {
        ...
        if (temp.uiSoundId)
        {
            if (!sSoundEntriesStore.LookupEntry(temp.uiSoundId))
                TC_LOG_ERROR(LOG_FILTER_SQL, "TSCR: Entry %i in table `script_texts` has soundId %u but sound does not exist.", iId, temp.uiSoundId);
        }
...
void SystemMgr::LoadScriptTextsCustom()
{
    ...
    do
    {
        ...
        {
            if (!sSoundEntriesStore.LookupEntry(temp.uiSoundId))
                TC_LOG_ERROR(LOG_FILTER_SQL, "TSCR: Entry %i in table `custom_texts` has soundId %u but sound does not exist.", iId, temp.uiSoundId);
        }
