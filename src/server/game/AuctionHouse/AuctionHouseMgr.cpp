...
uint32 AuctionHouseMgr::GetAuctionDeposit(uint32 p_DepositTime, Item* p_Item, uint32 p_ItemCount)
{
    ...
    TC_LOG_DEBUG(LogFilterType::LOG_FILTER_AUCTIONHOUSE, "SellPrice:  %u", l_SellPrice);
    TC_LOG_DEBUG(LogFilterType::LOG_FILTER_AUCTIONHOUSE, "Items:      %u", p_ItemCount);
    TC_LOG_DEBUG(LogFilterType::LOG_FILTER_AUCTIONHOUSE, "Deposit:    %u", l_Deposit);
