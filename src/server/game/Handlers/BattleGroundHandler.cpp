...
void WorldSession::HandleBattlemasterJoinOpcode(WorldPacket& p_Packet)
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_NETWORKIO, "Battleground: invalid bgtype (%u) received. possible cheater? player guid %u", l_BGTypeID_, m_Player->GetGUIDLow());
        return;
    }
...
void WorldSession::HandleBattleFieldPortOpcode(WorldPacket& p_Packet)
{
    ...
    switch (l_AcceptedInvite)
    {
        ...
        case 0:
            ...
            break;
        default:
            TC_LOG_ERROR(LOG_FILTER_NETWORKIO, "Battleground port: unknown action %u", l_AcceptedInvite);
            break;
    }
#endif /* not CROSS */
}
...
void WorldSession::HandleBattlemasterJoinRated(WorldPacket & /*p_Packet*/)
{
    ...
    if (!l_Battleground)
    {
        TC_LOG_ERROR(LOG_FILTER_NETWORKIO, "Battleground: template bg (10 vs 10) not found");
        return;
    }
