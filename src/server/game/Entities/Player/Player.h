        ...
        */
        ...
        void SetArenaPersonalRating(uint8 p_Slot, uint32 p_Value)
        {
            ...
            if (p_Value > 3500)
            {
                ...
                TC_LOG_ERROR("misc", "Suspiciously high personal rating. Rating: %u, Slot: %u, Player: %u, Trace log: %s", p_Value, p_Slot, GUID_LOPART(GetGUID()), trace.c_str());
            }
        ...
        void SetArenaMatchMakerRating(uint8 slot, uint32 value)
        {
            ...
            {
                ACE_Stack_Trace trace;
                TC_LOG_ERROR("misc", "Suspiciously high match maker rating. Rating: %u, Slot: %u, Player: %u, Trace log: %s", value, slot, GUID_LOPART(GetGUID()), trace.c_str());
            }
