...
void ObjectMgr::LoadLFRAccessRequirements()
{
    ...
    do
    {
        ...
        if (l_LFRAccessReq.Item)
        {
            ...
            if (!l_ItemTemplate)
            {
                TC_LOG_ERROR("misc", "Key item %u does not exist for dungeon ID %u, removing key requirement.", l_LFRAccessReq.Item, l_DungeonID);
        ...
        if (l_LFRAccessReq.Item2)
        {
            ...
            if (!l_ItemTemplate)
            {
                TC_LOG_ERROR("misc", "Second item %u does not exist for dungeon ID %u, removing key requirement.", l_LFRAccessReq.Item2, l_DungeonID);
