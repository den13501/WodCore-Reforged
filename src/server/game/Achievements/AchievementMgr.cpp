...
bool AchievementCriteriaData::IsValid(CriteriaEntry const* p_Criteria)
{
    ...
    {
        TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_criteria_data` for criteria (Entry: %u) has wrong data type (%u), ignored.", p_Criteria->ID, dataType);
        return false;
    }
    ...
    switch (p_Criteria->Type)
    {
        ...
        default:
            ...
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_criteria_data` has data for non-supported criteria type (Entry: %u Type: %u), ignored.", p_Criteria->ID, p_Criteria->Type);
                return false;
            }
            break;
    }
    ...
    switch (dataType)
    {
        ...
        */
        ...
        case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
            ...
            return true;
        default:
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_criteria_data` (Entry: %u Type: %u) has data for non-supported data type (%u), ignored.", p_Criteria->ID, p_Criteria->Type, dataType);
            return false;
    }
}
...
void AchievementMgr<T>::UpdateAchievementCriteria(AchievementCriteriaTypes p_Type, uint64 p_MiscValue1 /*= 0*/, uint64 p_MiscValue2 /*= 0*/, uint64 p_MiscValue3 /*= 0*/, Unit const* p_Unit /*= NULL*/, Player* p_ReferencePlayer /*= NULL*/, bool p_LoginCheck)
{
    ...
    {
        TC_LOG_DEBUG(LOG_FILTER_ACHIEVEMENTSYS, "UpdateAchievementCriteria: Unknown criteria type [%u]", p_Type);
        return;
    }
...
bool AchievementMgr<T>::CanUpdateCriteria(CriteriaEntry const* p_Criteria, AchievementEntry const* p_Achievement, uint64 p_MiscValue1, uint64 p_MiscValue2, uint64 p_MiscValue3, Unit const* p_Unit, Player* p_ReferencePlayer)
{
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Disabled",
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Wrong map",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Wrong faction",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Cannot update non-guild achcievement",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Is Completed",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Requirements not satisfied",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Additional requirements not satisfied",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
    ...
    {
        TC_LOG_TRACE(LOG_FILTER_ACHIEVEMENTSYS, "CanUpdateCriteria: (Id: %u Type %s) Conditions not satisfied",
            p_Criteria->ID, AchievementGlobalMgr::GetCriteriaTypeString(p_Criteria->Type));
        return false;
    }
...
void AchievementGlobalMgr::LoadAchievementCriteriaList()
{
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u achievement criteria in %u ms", l_CriteriaCount, GetMSTimeDiffToNow(l_OldMSTime));
}
...
void AchievementGlobalMgr::LoadAchievementReferenceList()
{
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u achievement references in %u ms", l_Counter, GetMSTimeDiffToNow(l_OldMSTime));
}
...
void AchievementGlobalMgr::LoadAchievementCriteriaData()
{
    ...
    do
    {
        ...
        if (!l_Criteria)
        {
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_criteria_data` has data for non-existing criteria (Entry: %u), ignore.", l_CriteriaID);
            continue;
        }
        ...
        if (strcmp(l_ScriptName, "")) // Not empty
        {
            if (l_DataType != ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT)
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_criteria_data` has ScriptName set for non-scripted data type (Entry: %u, type %u), useless data.", l_CriteriaID, l_DataType);
            else
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u additional achievement criteria data in %u ms", l_Count, GetMSTimeDiffToNow(l_OldMSTime));
}
...
void AchievementGlobalMgr::LoadCompletedAchievements()
{
    ...
    do
    {
        ...
        if (!l_Achievement)
        {
            ...
            TC_LOG_ERROR(LOG_FILTER_ACHIEVEMENTSYS, "Non-existing achievement %u data removed from table `character_achievement`.", l_AchievementID);
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %lu completed achievements in %u ms", (unsigned long)m_allCompletedAchievements.size(), GetMSTimeDiffToNow(l_OldMSTime));
}
#endif
...
void AchievementGlobalMgr::LoadRewards()
{
    ...
    do
    {
        ...
        if (!l_Achievement)
        {
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` has wrong achievement (Entry: %u), ignored.", l_Entry);
            continue;
        }
        ...
        {
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) does not have title, spell or item reward data, ignored.", l_Entry);
            continue;
        }

        if (l_Achievement->Faction == ACHIEVEMENT_FACTION_ANY && ((l_Reward.titleId[0] == 0) != (l_Reward.titleId[1] == 0)))
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has title (A: %u H: %u) for only one team.", l_Entry, l_Reward.titleId[0], l_Reward.titleId[1]);
        ...
        if (l_Reward.titleId[0])
        {
            ...
            if (!l_TitleEntry)
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has invalid title id (%u) in `title_A`, set to 0", l_Entry, l_Reward.titleId[0]);
        ...
        if (l_Reward.titleId[1])
        {
            ...
            if (!l_TitleEntry)
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has invalid title id (%u) in `title_H`, set to 0", l_Entry, l_Reward.titleId[1]);
        ...
        if (l_Reward.sender)
        {
            ...
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has invalid creature entry %u as sender, mail reward skipped.", l_Entry, l_Reward.sender);
                l_Reward.sender = 0;
            }
        }
        else
        {
            if (l_Reward.itemId)
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) does not have sender data but has item reward, item will not be rewarded.", l_Entry);

            if (!l_Reward.subject.empty())
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) does not have sender data but has mail subject.", l_Entry);

            if (!l_Reward.text.empty())
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) does not have sender data but has mail text.", l_Entry);
        }
        ...
        if (l_Reward.itemId)
        {
            ...
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has invalid item id %u, reward mail will not contain item.", l_Entry, l_Reward.itemId);
                l_Reward.itemId = 0;
            }
        ...
        if (l_Reward.SpellID)
        {
            ...
            {
                TC_LOG_ERROR(LOG_FILTER_SQL, "Table `achievement_reward` (Entry: %u) has invalid SpellID %u", l_Entry, l_Reward.SpellID);
                l_Reward.SpellID = 0;
            }
        }
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %u achievement rewards in %u ms", l_Counter, GetMSTimeDiffToNow(l_OldMSTime));
}
...
void AchievementGlobalMgr::LoadRewardLocales()
{
    ...
    do
    {
        ...
        {
            TC_LOG_ERROR(LOG_FILTER_SQL, "Table `locales_achievement_reward` (Entry: %u) has locale strings for non-existing achievement reward.", l_Entry);
            continue;
        }
    ...
    TC_LOG_INFO(LOG_FILTER_SERVER_LOADING, ">> Loaded %lu achievement reward locale strings in %u ms", (unsigned long)m_achievementRewardLocales.size(), GetMSTimeDiffToNow(l_OldMSTime));
}
